...
usertrap(void)
{
  ...
  if(which_dev == 2)
  {
	...
	if (p->alarm_interval > 0 && p->ticks >= p->alarm_interval && !p->in_alarm_handler) {
		...
		p->alarm_context.s6 = p->trapframe->s6;                                                                                 p->alarm_context.s7 = p->trapframe->s7;
	        p->alarm_context.s8 = p->trapframe->s8;                                                                                 p->alarm_context.s9 = p->trapframe->s9; 
		...
		p->alarm_context.t2 = p->trapframe->t2;                                                                                 p->alarm_context.t3 = p->trapframe->t3;                                                                                 p->alarm_context.t4 = p->trapframe->t4;                         
		...
		p->alarm_context.a3 = p->trapframe->a3;                                                                                 p->alarm_context.a4 = p->trapframe->a4;  
		p->alarm_context.a5 = p->trapframe->a5;                                                                                 p->alarm_context.a6 = p->trapframe->a6;                                                                                 p->alarm_context.a7 = p->trapframe->a7; 
		
		// return to alarm handler                                                                                              
		p->trapframe->epc = p->alarm_handler;                                                                                   p->ticks = 0;                                                                                                                                      
